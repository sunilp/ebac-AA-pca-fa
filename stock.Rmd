...
Here, we can see for PC1, the Velocity of liquid Assets , Asset Liablity ratio and Equity multiplier is having negative correlation with everything else, i.e the more assets , likely to have stronger stock price.
